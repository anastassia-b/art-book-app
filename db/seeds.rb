...
project11 = Project.create(user_id: egon.id, title: "sonnenbaum", description: "Egon Schiele | Sonnenbaum",
...
project6 = Project.create(user_id: onchi.id, title: "untitled", description: "Koshiro Onchi | Untitled",
...
project7 = Project.create(user_id: kelly.id, title: "yellow white", description: "Ellsworth Kelly | Yellow White",
...
project8 = Project.create(user_id: wayne.id, title: "painting", description: "Wayne Thiebaud | Painting",
